...
public class PositionToPickup extends CommandBase {
  ...
  public PositionToPickup(RevDrivetrain drive, double max) {
  ...
  public void initialize() {
      ...
      m_endpoint =m_drive.getHidePickupDistance();
      SmartDashboard.putNumber("MEP",m_endpoint);
    if (RobotBase.isReal())
