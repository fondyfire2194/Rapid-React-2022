...
public class AccelVolts extends CommandBase {
  ...
  public void initialize() {
    ...
    voltsIncrementPer100ms = .1;// accelerate at .1 volt per second
    //10 volts = 3 mps so .1 volt/sec= .03 mps/s
    maxVolts = 5;
  }
  ...
  public void execute() {
    ...
    m_drive.currentVolts += voltsIncrementPer100ms;
