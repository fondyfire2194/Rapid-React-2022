...
public class ShootLowFromUnderHub extends SequentialCommandGroup {
  /** Creates a new ShootHighFromUnderHub. */

  private double tiltAngle = 14;
  private double shootrpm = 1500;

  public ShootLowFromUnderHub(RevShooterSubsystem shooter, RevTiltSubsystem tilt, CargoTransportSubsystem transport,
