...
public class PositionTiltToCamera extends CommandBase {
  ...
  public PositionTiltToCamera(RevTiltSubsystem tilt) {
  ...
  public void initialize() {
    ...
    m_tilt.targetAngle = m_tilt.cameraCalculatedTiltPosition;
;
